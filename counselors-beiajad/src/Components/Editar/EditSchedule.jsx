...
//------------------------------------------------------------------------------------------------------
   ...
   useEffect(() => {
    ...
    const editDate = ()=>{
      ...
      Swal.fire({
        title: `Tu cita sera reprogramada con el Dr. ${doctorName} ${doctorLname}, para el ${date.slice(0,10)} ${time} hrs.`,
        icon: 'warning',
          ...
          <div className="calendar1">
            ...
            <Modal.Title>Edita tu cita</Modal.Title>
              ...
              <Form>
                ...
                <Button type="submit" onClick={() => {editDate()}} className="btn btn-info boton">Siguiente</Button>
              </Modal.Footer>
            </Modal>
            </div>
        ) : (
